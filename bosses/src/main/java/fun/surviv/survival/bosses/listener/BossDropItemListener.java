...
/**
 * SurvivalSystem; fun.surviv.survival.bosses.listener:BossDropItemListener
 *
 * @author LuciferMorningstarDev - https://github.com/LuciferMorningstarDev
 * @since 12.08.2022
 */
public class BossDropItemListener implements Listener {

    private final BossManager manager;

    public BossDropItemListener(BossManager manager) {
        this.manager = manager;
    }

    @EventHandler
    public void bossDropItem(EntityDropItemEvent event) {
